    ...
    */
    TskModule::Status TSK_MODULE_EXPORT report() {
        ...
        try{
            ...
            msg << "Logging report to " << outputPath.c_str();
            LOGINFO(msg.str());
            
            Poco::FileOutputStream out(outputPath);
        ...
        {
            std::stringstream msg;
            msg << "ReportModule - Caught framework exception: " << tskEx.what();
            LOGERROR(msg.str());
            return TskModule::FAIL;
        }
        ...
        {
            std::stringstream msg;
            msg << "ReportModule - Caught exception: " << ex.what();
            LOGERROR(msg.str());
            return TskModule::FAIL;
        }
